...
public class Dama extends Pieza {
    ...
    /**
     * Offset de coordenadas (fila, columna) que indican las DIRECCIONES hacia
     * donde puede moverse la Dama<br>
     * <br>
     * Diagonales: {-1, -1}, {-1, 1}, {1, -1}, {1, 1}<br>
     * Ejes H/V: {0, -1}, {0, 1}, {1, 0}, {-1, 0}<br>
     */
